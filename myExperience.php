...
<form id="formExperience" method="POST" action="">
   ...
   <p>
  <a href='addExperience.html' class="btn btn-default" style='color:#B40431;'><span class='glyphicon glyphicon-plus-sign'></span> Add Job Experience</a>
  <a href='editExperience.html' class="btn btn-default" style='color:#B40431;'><span class='glyphicon glyphicon-plus-edit'></span> Edit</a>
  </p>
...
<?php
  ...
  if ($result->num_rows != 0) {
   ...
   // echo out the contents of each row into a table
    echo "<tr>";
    echo "<td   width='200'><span style='font-weight:bold;'>" ."Position :" ."</td>";
    echo '<td>' . $row[1] . '</td>';
    echo "</tr>";
    echo "<tr>";
    ...
    echo "</tr>";
     echo "<tr>";
    echo "<td><span style='font-weight:bold;'>" ."Referee Name :" ."</td>";
    echo '<td>' . $row[8] . '</td>';
    echo "</tr>";
     echo "<tr>";
    echo "<td><span style='font-weight:bold;'>" ."Referee Contact No :" ."</td>";
    echo '<td>' . $row[9] . '</td>';
    echo "</tr>";
    echo "<tr>";
    echo '<td>'. "&nbsp;" .'</td>';
