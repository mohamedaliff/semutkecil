...
<form action="" method="POST">
               <p>
  <a href='addAchievement.html' class="btn btn-default" style='color:#B40431;'><span class='glyphicon glyphicon-plus-sign'></span> Add Achievement/Awards</a>&nbsp;
   <a href='editAchievement.html' class="btn btn-default" style='color:#B40431;'><span class='glyphicon glyphicon-edit'></span> Edit</a>
  </p>
...
<?php
  ...
  if ($result->num_rows != 0) {
     ...
     // display data in table
      ...
      echo "<div id='body'>";
      echo "<div id='content'>";
      echo "<table align='center' border='1' width='800' class='table table-striped table-bordered table-hover table-condensed'>";
