...
<?php
  ...
  if ($result->num_rows != 0) {
   ...
   // echo out the contents of each row into a table
    ...
    echo '<td><select id="languageEva1" name="languageEva1[]" style="width:60px;float:left;" class="form-control" disabled>
    ...
    echo '<td><select id="languageEva2" name="languageEva2[]" style="width:60px;float:left;" class="form-control">
            <option value="" selected></option>
            <option value="1">1</option>
            <option value="2">2</option>
            <option value="3">3</option>
...
<?php
  ...
  if ($result->num_rows != 0) {
   ...
   // echo out the contents of each row into a table
    ...
    echo '<td>' . $row[1] . '</td>';
    echo '<td>' . $row[2] . '</td>';
    echo '<td><select id="skillEva1" name="skillEva1[]" style="width:60px;float:left;" class="form-control" disabled>
            <option value="" selected></option>
            <option value="1">1</option>
            <option value="2">2</option>
            <option value="3">3</option>
    ...
    echo '<td><select id="skillEva2" name="skillEva2[]" style="width:60px;float:left;" class="form-control">
            <option value="" selected></option>
            <option value="1">1</option>
            <option value="2">2</option>
            <option value="3">3</option>
...
<?php
  ...
  if ($result->num_rows != 0) {
   ...
   // echo out the contents of each row into a table
    ...
    echo '<td>' . "&nbsp;" . '</td>';
    echo '<td>' . "&nbsp;" . '</td>';
    echo '<td><select id="skillEva1" name="educationEva1" style="width:60px;float:left;" class="form-control" disabled>
            <option value="" selected></option>
            <option value="1">1</option>
            <option value="2">2</option>
            <option value="3">3</option>
    ...
    echo '<td><select id="skillEva2" name="educationEva2" style="width:60px;float:left;" class="form-control">
            <option value="" selected></option>
            <option value="1">1</option>
            <option value="2">2</option>
            <option value="3">3</option>
...
<?php
  ...
  if ($result->num_rows != 0) {
   ...
   // echo out the contents of each row into a table
    ...
    echo '<td>' . $row[2] . '</td>';
    echo '<td>' . $row[3] . '</td>';
    echo '<td><select id="cocoEva1" name="cocoEva1[]" style="width:60px;float:left;" class="form-control" disabled>
            <option value="" selected></option>
            <option value="1">1</option>
            <option value="2">2</option>
            <option value="3">3</option>
    ...
    echo '<td><select id="cocoEva2" name="cocoEva2[]" style="width:60px;float:left;" class="form-control">
            <option value="" selected></option>
            <option value="1">1</option>
            <option value="2">2</option>
            <option value="3">3</option>
...
<?php
  ...
  if ($result->num_rows != 0) {
   ...
   // echo out the contents of each row into a table
    ...
    echo '<td>' . $row[2] . '</td>';
    echo '<td>' . $row[3] . '</td>';
    echo '<td><select id="achieveEva1" name="achieveEva1[]" style="width:60px;float:left;" class="form-control" disabled>
            <option value="" selected></option>
            <option value="1">1</option>
            <option value="2">2</option>
            <option value="3">3</option>
    ...
    echo '<td><select id="achieveEva2" name="achieveEva2[]" style="width:60px;float:left;" class="form-control">
            <option value="" selected></option>
            <option value="1">1</option>
            <option value="2">2</option>
            <option value="3">3</option>
...
echo "<input type='submit' style='float:right;'' value='Save' id='btnSubmit' name='submit' class='btn btn-success' data-toggle='tooltip' title='Save evaluation' />";
echo "</td>";
echo "</tr>";
echo "</table>";
...
$lid = ($_POST['lid']);
$planguage2 = ($_POST['languageEva2']);

$sid = ($_POST['sid']);
$pskill2 = ($_POST['skillEva2']);


$peducation2 = ($_POST['educationEva2']);

$cid = ($_POST['cid']);
$pcoco2 = ($_POST['cocoEva2']);

$aid = ($_POST['aid']);
$pachievement2 = ($_POST['achieveEva2']);


$studentId = ($_POST['studid']);
$mid = ($_POST['postid']);

 if ($planguage2 == '' || $pskill2 == '' || $peducation2 == '' || $pcoco2 == '' || $pachievement2 == '')
{
...
<?php
 ...
 if ( $stmt = $mysqli->prepare( "UPDATE tblpointer SET peducation2 = ? WHERE studentId=? AND mId=?"))
 
   {

    $stmt->bind_param("dsi",$peducation2, $studentId, $mid); 
    $stmt->execute();
    $stmt->close();
...
for( $i = 0 ; $i < count( $planguage2 ) ; $i++ ) {


if ( $stmt = $mysqli->prepare( "UPDATE tblplanguage SET planguage2=? WHERE lId=?"))
 
   {

    $stmt->bind_param("di",$planguage2[$i], $lid[$i]); 
    $stmt->execute();
    $stmt->close();
...
for( $i = 0 ; $i < count( $pskill2 ) ; $i++ ) {


if ( $stmt = $mysqli->prepare( "UPDATE tblpskill SET pskill2 = ? WHERE sId=?"))
 
   {

    $stmt->bind_param("di",$pskill2[$i], $sid[$i]); 
    $stmt->execute();
    $stmt->close();
...
for( $i = 0 ; $i < count( $pcoco2 ) ; $i++ ) {


if ( $stmt = $mysqli->prepare( "UPDATE tblpcoco SET pcoco2 = ? WHERE cId=?"))
 
   {

    $stmt->bind_param("di",$pcoco2[$i],  $cid[$i]); 
    $stmt->execute();
    $stmt->close();
...
for( $i = 0 ; $i < count( $pachievement2 ) ; $i++ ) {

if ( $stmt = $mysqli->prepare( "UPDATE tblpachieve SET pachieve2 = ? WHERE aId=?"))
 
   {

    $stmt->bind_param("di",$pachievement2[$i],$aid[$i]); 
    $stmt->execute();
    $stmt->close();
