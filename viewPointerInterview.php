...
?>
<?php
function renderForm($id, $studentId, $mId, $studentName,$date,$interviewby,$evaedu,$evaexp,$evaskill,$evacomm,$evaent,$evafinal,$comment1,$comment2,$comment3,$comment4,$comment5,$comment6,$totalmark)
 {
...
<table border="0" align="center" width="700">
      ...
      <td width="30"><input type="text" name="total" value="<?php echo $totalmark; ?>" style="text-align:center;width:40px;float:right;color:red;font-weight:bold;" readonly/></td>
        ...
        <td width="30" align="right" style="font-weight:bold;"> / 50 </td>
    </tr>
...
if (isset($_GET['id']) && is_numeric($_GET['id']) && $_GET['id'] > 0)
 ...
 // query db
    ...
    if ($result = $mysqli->query("SELECT tblevainterviewgb.interviewId,tblevainterviewgb.evaedu,tblevainterviewgb.evaexp,tblevainterviewgb.evaskill,tblevainterviewgb.evacom,tblevainterviewgb.evaent,tblevainterviewgb.evafinal,tblevainterviewgb.comment1,tblevainterviewgb.comment2,
tblevainterviewgb.comment3,tblevainterviewgb.comment4,tblevainterviewgb.comment5,tblevainterviewgb.comment6,tblevainterviewgb.postId,tblevainterviewgb.studentId,tblevainterviewgb.total,tblevainterviewgb.interviewdate,tblevainterviewgb.interviewby,tblstudent.studentName,
tblapplymobilization.mId,tblapplymobilization.otherId FROM tblstudent
INNER JOIN tblevainterviewgb ON tblevainterviewgb.studentId = tblstudent.studentId
INNER JOIN tblapplymobilization ON tblevainterviewgb.studentId = tblapplymobilization.studentId AND tblevainterviewgb.postId = tblapplymobilization.otherId WHERE mId = $id" )) {
 ...
 // show form
 renderForm($id, $studentId, $mId, $studentName,$date,$interviewby,$evaedu,$evaexp,$evaskill,$evacomm,$evaent,$evafinal,$comment1,$comment2,$comment3,$comment4,$comment5,$comment6,$totalmark);
 $mysqli->close();
}
}
}
