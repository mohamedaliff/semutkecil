...
<header>
  ...
  <h3>Invitation to INTRA interview</h1>
...
<div class="sub">Your qualifications make you an excellent candidate for this role to undergo Industrial Training at our company. So, we would like to invite you for an interview at our office. <br>&nbsp;</br></div>
      ...
      <div class="sub">The position we are offering is <?php echo $position; ?> with monthly allowance at range of <?php if ($allowance < 101){
          echo "Not Available";
...
if (isset($_GET['id']) && is_numeric($_GET['id']) && $_GET['id'] > 0)
 ...
 // query db
    ...
    if ($result = $mysqli->query("SELECT tblpartner.companyName,tblpartner.companyUsername,tblofferjob.offerid,tblofferjob.companyId,
tblofferjob.studentId,tblofferjob.position,tblofferjob.itime,tblofferjob.ivenue,tblofferjob.information,tblofferjob.idate,tblofferjob.offerdate,tblofferjob.allowance,tblstudent.studentName,tblpartner.companyAddress,
