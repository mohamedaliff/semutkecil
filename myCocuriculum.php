...
<form action="" method="POST">
               <p>
  <a href='addCocuriculum.html' class="btn btn-default" style='color:#B40431;'><span class='glyphicon glyphicon-plus-sign'></span> Add Co-curricular Activities</a>&nbsp;
   <a href='editCocuriculum.html' class="btn btn-default" style='color:#B40431;'><span class='glyphicon glyphicon-edit'></span> Edit</a>
  </p>
...
<?php
  ...
  if ($result->num_rows != 0) {
     ...
     // display data in table
      ...
      echo "<div id='body'>";
      echo "<div id='content'>";
      echo "<table align='center' border='1' width='800' class='table table-bordered table-hover table-condensed'>";
