...
function validateForm(theForm) {
   with(theForm) {
      ...
      return (isNotEmpty(txtName, "Please enter company name!", elmNameError)
			&& isSelected(selType, "Please make a selection!", elmTypeError)
			//&& isNumeric(txtNo, "Please enter a valid registration code!", elmNoError)
         && isNotEmpty(txtNo, "Please enter a valid registration code!", elmNoError)
			&& isNotEmpty(txtAddress, "Please enter address!", elmAddressError)
			&& isNotEmpty(txtCity, "Please enter city!", elmCityError)
            && isNotEmpty(txtPostcode, "Please enter post code!", elmPostcodeError)
            && isLengthMinMax(txtPostcode, 5, 5, "Please enter 5-digit post code!", elmPostcodeError)
		    && isSelected(selState, "Please make a selection!", elmStateError)
		    ...
		    && isNotEmpty(txtUsername, "Please enter username!", elmUsernameError)
            && isValidPassword(txtPassword, "Password shall be 6-8 characters!", elmPasswordError)
			&& isNotEmpty(txtPWVerified, "Please verify password!", elmPWVerifiedError)
            && verifyPassword(txtPassword, txtPWVerified, "Password not match!",
                 elmPWVerifiedError)
			&& isChecked("cbPolicy", "Please accept our terms of use!", elmPolicyError)
      );
   }
}
