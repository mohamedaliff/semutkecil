...
<form id="formPersonalInfo" method="POST" action="myEducation.php">
...
<?php
  ...
  if ($result->num_rows != 0) {
     ...
     // display data in table
      echo "<p>"; 
      echo '<a href="updateEducation.php" class="btn btn-default" style="color:#B40431;"><span class="glyphicon glyphicon-edit"></span> Edit</a>';
      echo "</p>";                 
      echo "<div id='body'>";
      echo "<div id='content'>";
   ...
   // echo out the contents of each row into a table
    ...
    echo "<a href='addEducation.html' class='btn btn-default' style='color:#B40431;'><span class='glyphicon glyphicon-plus-sign'></span> Add Education</a>";
