...
<head>
   <title>UniKl MIIT INTRA Management System</title>
     <link rel="icon" type="image/ico" href="image/favicon.ico"><title>Manage INTRA Request</title>
...
echo "<input type='submit' value='Save' id='btnSubmit' name='submit' class='btn btn-success' data-toggle='tooltip' title='Save evaluation' />";
echo "</td>";
echo "</tr>";
echo "</table>";
