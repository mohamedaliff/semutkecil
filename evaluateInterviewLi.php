...
?>
<?php
function renderForm($id, $studentId, $postId, $studentName,$date,$time)
 {
...
or training for this position?</font></td>
    <tr>      
        <td colspan="2"><input required type="radio" id="evaedu" name="evaedu" value="1"> 1&nbsp;&nbsp;&nbsp;
...
past work experiences?</font></td>
    <tr>      
        <td colspan="2"><input required type="radio" id="evaexp" name="evaexp" value="1"> 1&nbsp;&nbsp;&nbsp;
...
for this position?</font></td>
    <tr>      
        <td colspan="2"><input required type="radio" id="evaskill" name="evaskill" value="1"> 1&nbsp;&nbsp;&nbsp;
    ...
    <tr>      
        <td width="100" colspan="2"><font style="font-weight:bold;">Candidate Enthusiasm - </font>How much interest did the candidate show in the position?</font></td>
    <tr>      
        <td colspan="2"><input required type="radio" id="evaent" name="evaent" value="1"> 1&nbsp;&nbsp;&nbsp;
...
proceeding with this candidate.</font></td>
    <tr>      
        <td colspan="2"><input required type="radio" id="evafinal" name="evafinal" value="1"> 1&nbsp;&nbsp;&nbsp;
    ...
    <tr>
      <td><font style="font-weight:bold;">Comments: </font></td>
      <td><textarea required rows="1" type="text" id="comment6" name="comment6" style="width:600px;float:left;" class="form-control" placeholder="Enter Comment" /></textarea></td>
    </tr>
    <tr>
      <td>&nbsp;</td>
    </tr>
...
if (isset($_GET['id']) && is_numeric($_GET['id']) && $_GET['id'] > 0)
 ...
 // query db
    ...
    if ($result = $mysqli->query("SELECT tblapplyjob.applyId,tblstudent.studentName,tblapplyjob.studentId,tblapplyjob.postId
FROM tblapplyjob INNER JOIN tblstudent ON tblapplyjob.studentId = tblstudent.studentId WHERE applyId = $id" )) {
 ...
 // show form
 renderForm($id, $studentId, $postId, $studentName,$date,$time);
 $mysqli->close();
}
}
}
