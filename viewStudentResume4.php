...
<?php
      ...
      if ($result = $mysqli->query("SELECT * FROM tblevainterviewli WHERE studentId=$studentId AND postId=$postId"))
    {
  if ($result->num_rows == 0) {
...
<table border="0" width="1000" align="left">
            <tr>
              <td width="190">        
                <a class="btn btn-primary" style="float:right;" href="evaluateInterviewLi.php?id=<?php echo $id; ?>" data-toggle="tooltip" title="Click to evaluate interview" >Start Evaluate Interview</a>
              </td>
            </tr>
</table>
